//api/pharmaciebackend/bondecommandes/[bondecommandeId]/devis/create/route.ts
...
export async function POST(
  ...
  try {
    ...
    const { items }: { items: BondecommandeItemInput[] } = body;
    ...
    await prisma.bondecommandeItem.deleteMany({
