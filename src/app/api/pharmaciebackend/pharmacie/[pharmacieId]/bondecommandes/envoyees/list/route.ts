// ✅ /api/pharmaciebackend/pharmacie/[pharmacieId]/bondecommandes/envoyees/list/route.ts
//Il affiche tous les bondecommandes envoyées par les client à cette pharmacie
