// ✅ /api/pharmaciebackend/pharmacie/[pharmacieId]/ordonnances/devis_recu/list/route.ts
//Il affiche tous les ordonnances dont la pharmacie à déja envoyé un devis donc ils ont statut "DEVIS_RECU" dans cette pharmacie
