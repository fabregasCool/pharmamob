...
//Recupérer la liste des bondecommandes qui ont été déja payées
...
export async function GET(req: Request) {
  try {
    ...
    // 4️⃣ Récupérer toutes les bondecommandes PAYEE de cet utilisateur (non supprimées)
    ...
    console.error("❌ Erreur GET /api/bondecommandes/payees/list:", err);
