//api/clientbackend/bondecommandes/devis_recu/list/route.ts
//Recupérer la liste des bondecommandes qui ont recu des devis
...
export async function GET(req: Request) {
  try {
    ...
    // 4️⃣ Récupérer toutes les bondecommandes DEVIS_RECU de cet utilisateur (non supprimées)
    ...
    console.error("❌ Erreur GET /api/bondecommandes/devis_recu/list:", err);
