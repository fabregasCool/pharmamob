// ✅ /api/adminbackend/bondecommandes/envoyees/list/route.ts
...
export async function GET(req: Request) {
  try {
    ...
    // 4️⃣ Récupérer toutes les bondecommandes avec statut ENVOYEE
    ...
    console.error(
      "❌ Erreur GET /api/adminbackend/bondecommandes/envoyees/list:",
      err
    );
