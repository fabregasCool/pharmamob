// ✅ /api/adminbackend/ordonnances/devis_recu/list/route.ts
...
export async function GET(req: Request) {
  try {
    ...
    // 4️⃣ Récupérer toutes les ordonnances avec statut DEVIS_RECU
    ...
    console.error(
      "❌ Erreur GET /api/adminbackend/ordonnances/devis_recu/list:",
      err
    );
